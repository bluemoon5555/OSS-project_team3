...
void leftroom2F(){//조직방
   ...
   scene(
    ...
    "다행히 연휴기간이라 그런지 아무도 없는 모양이다...\n"
    "일기에 적힌대로라면, 이 방 안에 시설 내 주요 구역 비밀번호가 적힌 자료가 분명 있을거야...\n"
...
system("cls");
scene("\n보안실이다...\n"
"벽면을 가득채운 대형 모니터...이렇게 철통같은 보안 시스템이라니...\n"
"지금까지 단 한 사람도 탈출하지 못했다는 데에는 이유가 있었군...\n"
"일기 내용에 따르면 이곳에서 1층 열쇠보관함이 있는 방 주변의\n"
"경보 시스템을 해제할 수 있다고 한다...\n"
